...
final class TestExpectedValuesCalculator
{
    ...
    void testCalculateBothOnInterval() throws DataSetIllegalArgumentException
    {
        ...
        int expectedNumValues = DssDataExchangeWriter.getExpectedNumValues(start, end, "1Day", mockFirstTime, mockLastTime);
        ...
        expectedNumValues = DssDataExchangeWriter.getExpectedNumValues(start, end, "1Day", mockFirstTime, mockLastTime);
        ...
        expectedNumValues = DssDataExchangeWriter.getExpectedNumValues(start, end, "1Hour", mockFirstTime, mockLastTime);
